...
const Course2Container = () => {
    return (
        <div className="course">
            ...
            <h2 className="poemTitle">Love Is</h2>
            ...
            <p className="poemTitle">The Shell That Finally Broke Open</p>
            <p className="text">You meet thousands of people and none of them really get you. Then you meet one person and your life changes forever.<br/> <br /> ~ Alexa</p>
