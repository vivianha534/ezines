    ...
    return (
        <div className="course">
            ...
            <div className="courseButtonContainer">
                <a href="/course3"><button >Home</button></a>
                <a href="/course4"><button >Course 2</button></a>
            </div>
        </div>
    )
}
